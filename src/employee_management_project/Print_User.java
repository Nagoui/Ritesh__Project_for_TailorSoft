...
public class Print_User implements ActionListener {
...
//                password = rs.getString("password");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b2) {
            f.setVisible(false);
            User_Details d = new User_Details(temp);
        }
    }

    public static void main(String[] args) {
        new Print_User("Print Data");
    }
