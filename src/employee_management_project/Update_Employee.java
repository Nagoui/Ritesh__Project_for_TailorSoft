...
class Update_Employee extends Add_Employee implements ActionListener {
    ...
    Update_Employee(String mail) {
        ...
        id2 = new JLabel("Reporting manager:");
        ...
        id3 = new JLabel("Allocated Project");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b && i == 1) {
            try {
                conn con = new conn();
                String str = "update employee_details set password='" + t1.getText() + "',reporting_manager='" + t2.getText() + "',allocated_project='" + t3.getText() + "'";
