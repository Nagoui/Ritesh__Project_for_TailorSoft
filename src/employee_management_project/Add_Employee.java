...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id6= new JLabel("Reporting Manager");
        ...
        id7= new JLabel("AllocationProject");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String _name = t1.getText();
        String _email = t2.getText();
        String _password = t3.getText();
        String _desig = t4.getText();
        String _band = t5.getText();
        String _repo = t6.getText();
        String _project = t7.getText();

        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee_details values('"+_name+"','"+_email+"','"+_password+"','"+_desig+"','"+_band+"','"+_repo+"','"+_project+"','"+null+"','"+null+"')";
